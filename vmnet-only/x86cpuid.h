...
FLAGDEF(   1, ECX, INTEL,  27,  1, OSXSAVE,             NO,  MASK,   0, FALSE)            \
...
/* These CPUID bit definitions are not yet public. */
...
FLAGDEF(   1, ECX, INTEL,  11,  1, SLC64,               NO,  MASK,   0, FALSE)           \
FLAGDEF(   1, ECX, INTEL,  17,  1, PCIDASID,            NO,  MASK,   0, FALSE)           \
FLAGDEF(   1, ECX, INTEL,  24,  1, TSC_DEADLINE,        NO,  MASK,   0, FALSE)           \
FLAGDEF(   1, ECX, INTEL,  28,  1, AVX,                 NO,  MASK,   0, FALSE)           \
FLAGDEF(   6, EAX, INTEL,   2,  1, CONTINUOUS_LAPIC_TIMER, NA, IGNORE, 0, FALSE)
